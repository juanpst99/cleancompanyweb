...
Para cuándo: ${mapCuando[formData.cuando] || formData.cuando}`
    ...
    openWhatsApp(baseMessage, 'cotizacion_muebles')
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mt-8">
              ...
              <WhatsAppLink
                message={`Hola, quiero una cotización exacta para lavado de muebles en ${formatCiudad(ciudad)}. ¿Me pueden ayudar?`}
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <WhatsAppLink
            message={`Quiero aprovechar el ${descuento}% de descuento en lavado de muebles`}
