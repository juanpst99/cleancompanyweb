...
export default function AlfombrasClient() {
  ...
  const testimoniosAlfombras = [
    {
      ...
      texto: "Increíble servicio! Mi alfombra persa quedó como nueva. Eliminaron una mancha de vino que tenía años.",
      tiempo: "3 días"
    },
    {
      ...
      texto: "Puntuales y profesionales. El olor a humedad desapareció completamente. 100% recomendados.",
      tiempo: "1 semana"
    },
    {
      nombre: "Ana Gómez",
      ...
      texto: "Excelente relación calidad-precio. Mis alfombras quedaron impecables y el secado fue rapidísimo.",
      tiempo: "5 días"
    }
  ]
  ...
  return (
    <>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8">
              ...
              <div className="mt-6 text-center">
                <p className="text-sm text-gray-600">
                  <span className="font-semibold text-green-600">127 personas</span> cotizaron este servicio hoy
                </p>
              </div>
      ...
      {/* Tipos de alfombras que limpiamos */}
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Limpiamos Todo Tipo de Alfombras y Tapetes
          </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="text-center group hover:transform hover:scale-105 transition-all duration-300">
              <div className="bg-green-100 p-6 rounded-2xl mb-4 group-hover:bg-green-600 transition-colors">
                <svg className="w-12 h-12 text-green-600 mx-auto group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center group hover:transform hover:scale-105 transition-all duration-300">
              <div className="bg-purple-100 p-6 rounded-2xl mb-4 group-hover:bg-purple-600 transition-colors">
                <svg className="w-12 h-12 text-purple-600 mx-auto group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center group hover:transform hover:scale-105 transition-all duration-300">
              <div className="bg-yellow-100 p-6 rounded-2xl mb-4 group-hover:bg-yellow-600 transition-colors">
                <svg className="w-12 h-12 text-yellow-600 mx-auto group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Nuestro Proceso de Lavado Profesional
          </h2>
              ...
              <ol className="space-y-6">
                <li className="flex items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Evaluamos el tipo de alfombra, fibras y manchas específicas para elegir el mejor tratamiento</p>
                  </div>
                </li>
                <li className="flex items-start group">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center">
              ...
              <a 
                href={`https://wa.me/573128052720?text=Hola,%20quiero%20una%20cotización%20exacta%20para%20lavado%20de%20alfombras%20en%20${encodeURIComponent(ciudad)}.%20¿Me%20pueden%20ayudar?`}
                target="_blank"
     ...
     {/* FAQ optimizado para objeciones */}
     <section className="py-16 bg-white">
       <div className="container mx-auto px-4">
         <h2 className="text-3xl font-bold text-center mb-12">
         ...
         <div className="max-w-3xl mx-auto space-y-4">
           <details className="bg-gray-50 rounded-lg shadow-md p-6 group">
             ...
             <p className="mt-4 text-gray-600">
               Tenemos garantía de satisfacción 100%. Si alguna mancha persiste después del primer tratamiento, 
               regresamos sin costo adicional para aplicar técnicas especializadas. En el 95% de los casos, 
               eliminamos todas las manchas en la primera visita.
             </p>
           </details>
           ...
           <details className="bg-gray-50 rounded-lg shadow-md p-6 group">
             ...
             <p className="mt-4 text-gray-600">
               Con nuestro sistema de secado acelerado, tu alfombra estará completamente seca en 5 días. 
               El tiempo exacto depende del grosor de la alfombra y la ventilación del espacio. 
               Incluimos ventiladores industriales sin costo extra para acelerar el proceso.
             </p>
           </details>
           ...
           <details className="bg-gray-50 rounded-lg shadow-md p-6 group">
             ...
             <p className="mt-4 text-gray-600">
               No. Utilizamos productos pH neutro especialmente formulados para cada tipo de fibra. 
               Antes de comenzar, hacemos una prueba en un área poco visible. Nuestros productos 
               realzan los colores originales sin dañar las fibras.
             </p>
           </details>
           ...
           <details className="bg-gray-50 rounded-lg shadow-md p-6 group">
             ...
             <p className="mt-4 text-gray-600">
               Absolutamente seguro. Todos nuestros productos son biodegradables, no tóxicos y certificados. 
               Una vez seca la alfombra (5 días), es completamente segura para toda la familia, 
               incluyendo bebés y mascotas.
             </p>
           </details>
           ...
           <details className="bg-gray-50 rounded-lg shadow-md p-6 group">
             ...
             <p className="mt-4 text-gray-600">
               Para poder garantizar el buen secado de la alfombra, debemos llevar tu alfombra a Nuestras
               instalaciones en la cual contamos con la maquinaria adecuada y especializada para que tu
               alfombra quede impecable.
             </p>
           </details>
         </div>
       </div>
         ...
         <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
           <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
             ...
             <p className="text-gray-600">
               Si no quedas satisfecho, repetimos el servicio sin costo
             </p>
           </div>
           ...
           <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
             ...
             <p className="text-gray-600">
               Llegamos a la hora acordada o te damos 10% de descuento
             </p>
           </div>
           ...
           <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
             ...
             <p className="text-gray-600">
               Tratamos tu alfombra con el mismo cuidado que la nuestra
             </p>
           </div>
         </div>
       </div>
     ...
     {/* CTA Final con contador */}
     <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white relative overflow-hidden">
       <div className="absolute inset-0 bg-black opacity-10"></div>
       
       <div className="container mx-auto px-4 text-center relative z-10">
         <h2 className="text-4xl font-bold mb-4">
           ¿Listo para tener tu alfombra como nueva?
         </h2>
         ...
         <p className="mt-6 text-sm opacity-80">
           * Válido solo para nuevos clientes. Un uso por hogar. Aplica solo en {ciudad}.
         </p>
       </div>
     </section>

     {/* Botón de chat flotante adicional */}
