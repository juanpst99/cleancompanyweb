...
export const metadata: Metadata = {
  title: 'Lavado de Vehículos Interior en Bogotá y Medellín | Clean Company',
  description: 'Servicio profesional de limpieza interior de vehículos. Tapicería, alfombras y techos como nuevos. Clean Company.',
  keywords: ['lavado de carros bogotá', 'limpieza interior vehículos', 'lavado tapicería auto'],
}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center text-white max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-8 opacity-90">
              Servicio profesional de limpieza interior para autos, camionetas y SUVs en Bogotá y Medellín.
            </p>
            
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-8">
              <h2 className="text-2xl font-semibold mb-6">¿Qué incluye?</h2>
              <ul className="text-left max-w-md mx-auto space-y-3">
                ...
                <li className="flex items-center">
                  <Check className="w-5 h-5 text-green-400 mr-3 flex-shrink-0" />
                  Lavado de alfombras del vehículo
                </li>
                <li className="flex items-center">
                  <Check className="w-5 h-5 text-green-400 mr-3 flex-shrink-0" />
            ...
            <a 
              href="https://wa.me/573128052720?text=Hola,%20quiero%20cotizar%20limpieza%20interior%20de%20mi%20vehículo"
              target="_blank"
