...
export default function VuelveMedellinLanding() {
  return (
    <main className="min-h-screen bg-gray-50 font-sans pb-24 md:pb-0">
      ...
      <div className="bg-gradient-to-r from-[#2d8a29] to-[#1d5c1b] text-white text-center py-3 px-4 text-sm font-bold tracking-wide">
      ...
      <section className="relative bg-white pt-12 pb-16 lg:pt-20 lg:pb-24 border-b border-gray-100">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 tracking-tight leading-[1.1] mb-6">
            ¿Todavía pensándolo?{' '}
            <span className="text-[#3AAA35]">Mira lo que hicimos esta semana.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center max-w-lg mx-auto mb-4">
            ...
            <a
              href="#cotizador-ia"
              className="flex-1 flex items-center justify-center gap-2 bg-white text-[#3AAA35] text-lg font-bold py-4 px-6 rounded-xl shadow border border-green-200 hover:bg-green-50 transition-all"
            >
      ...
      <section className="py-10 bg-gradient-to-r from-[#3AAA35] to-[#266d25] text-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="flex flex-col items-center text-center p-5 rounded-2xl bg-gray-50 border border-gray-100">
              <div className="w-12 h-12 bg-green-100 text-[#3AAA35] rounded-full flex items-center justify-center mb-3">
      ...
      {/* ── CTA de cierre ──────────────────────────────────────────── */}
      <section className="py-16 bg-[#3AAA35]">
        <div className="max-w-2xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col items-center gap-4">
            <WhatsAppLink
              message={WA_MESSAGE}
              className="inline-flex items-center justify-center gap-2 bg-white text-[#3AAA35] text-lg font-extrabold py-4 px-8 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200"
            >
            ...
            <div className="flex flex-wrap justify-center gap-4 text-green-100 text-xs">
