...
export const metadata = {
  title: 'Lavado de Muebles y Sofás en Medellín | Clean Company',
  robots: {
    index: false,
    follow: false,
  },
...
const WA_MESSAGE = 'Hola Clean Company, quiero cotizar el lavado de muebles/sofás a domicilio en Medellín.'

// ─── Datos estáticos ──────────────────────────────────────────────────────────

const prices = [
  { item: 'Sala en L (hasta 5 puestos)', price: '$160.000' },
  { item: 'Sala en L grande (5+ puestos)', price: '$200.000' },
  { item: 'Sofá 3 puestos', price: '$105.000' },
  { item: 'Sofá 2 puestos', price: '$90.000' },
  { item: 'Poltrona', price: '$45.000' },
  { item: 'Silla de comedor', price: '$12.000' },
]
...
const testimonials = [
  ...
  {
    quote: 'Le derramaron café a mi sala y pensé que no tenía solución. Quedó impecable, sin olor ni marca.',
    name: 'Julián D.',
    city: 'Laureles',
  },
  {
    quote: 'Tres perros en casa y el sofá olía terrible. Después del lavado mis visitas ya no lo notan.',
    name: 'Valentina S.',
    city: 'Sabaneta',
  },
]
...
const faqs = [
  {
    q: '¿Cuánto cuesta lavar mi sofá o sala?',
    a: 'En Medellín, un sofá de 2 puestos desde $90.000 y una sala en L desde $160.000. El precio final depende del tipo de tela y el nivel de suciedad. Puedes usar nuestro cotizador con IA para un estimado inmediato o escribirnos por WhatsApp.',
  },
  {
    q: '¿Funciona con manchas viejas o muy difíciles?',
    a: 'Sí. Nuestro proceso de inyección-extracción está diseñado para manchas incrustadas: café, vino, grasa, tinta, orina de mascotas. El resultado depende del tiempo que lleve la mancha y del tipo de tela, pero en la mayoría de los casos logramos eliminarla o reducirla significativamente.',
  },
  {
    q: '¿Cuánto tarda en secar?',
    a: 'Entre 2 y 6 horas dependiendo de la tela y la ventilación. Con la extracción industrial retiramos gran parte de la humedad durante el proceso, así que no queda empapado.',
  },
  {
    q: '¿El proceso daña la tela?',
    a: 'No. Usamos productos biodegradables y ajustamos la presión según el tipo de tela (microfibra, cuero sintético, lino, etc.). Nuestros técnicos evalúan el material antes de empezar.',
  },
  {
    q: '¿Qué incluye el servicio?',
    a: 'Incluye limpieza profunda por inyección-extracción, tratamiento de manchas, desodorización y hoy agregamos protector de tela GRATIS. Revisas el resultado con el técnico antes de que se retire.',
  },
]

// ─── Page ─────────────────────────────────────────────────────────────────────

export default function MueblesMedellinLanding() {
  return (
    <main className="min-h-screen bg-gray-50 font-sans pb-24 md:pb-0">
      ...
      <div className="bg-gray-900 text-white text-center py-2 px-4 text-xs font-medium tracking-wide">
        ...
        Hoy: Protector de tela GRATIS con tu lavado de muebles en Medellín.
      </div>
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 text-center lg:text-left mb-12 lg:mb-0">
              ...
              <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto lg:mx-0">
                Lavado profesional de muebles y sofás con extracción industrial a domicilio.
                Sofás desde <strong>$90.000</strong> y salas en L desde <strong>$160.000</strong> en Medellín.
              </p>
              ...
              <div className="bg-gray-50 p-4 rounded-2xl border border-gray-100 inline-block text-left mt-6">
                <div className="flex items-center space-x-1 text-yellow-400 mb-1">
                  ...
                  <span className="text-gray-900 font-bold text-sm ml-2">4.9/5 en lavado de muebles</span>
                </div>
                <p className="text-xs text-gray-600 italic">
                  &ldquo;Le derramaron Coca-Cola al sofa y quedo peor que antes. Clean Company lo dejo impecable.&rdquo;{' '}
                  <span className="font-semibold">&mdash; Carolina P., Medellin</span>
                </p>
              </div>
            </div>

            {/* Tabla de precios — reemplaza LandingSelector */}
            <div className="lg:col-span-5 relative z-10">
              <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] p-6 sm:p-8 border border-gray-100">
                ...
                <p className="text-xs text-gray-400 text-center mb-5">
                  Incluye: extracción profunda + desodorización + protector de tela GRATIS
                </p>
                <WhatsAppLink
                  message={WA_MESSAGE}
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((t) => (
              <div key={t.name} className="bg-gray-50 rounded-2xl p-5 border border-gray-100">
                ...
                <p className="text-xs text-gray-500">Medellin, {t.city} &middot; Muebles</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-white border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Tu sofa como nuevo en 3 pasos</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6 rounded-2xl bg-gray-50 hover:bg-green-50 transition-colors">
              ...
              <p className="text-gray-600 text-sm">Nuestros tecnicos llegan con maquinaria industrial. Revisas el resultado antes de que se vayan.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-3">
              Sube una foto de tu mueble y conoce el precio
            </h2>
            <p className="text-gray-500 max-w-xl mx-auto">
              Nuestra IA analiza el tipo de mueble y te da un precio estimado al instante.
              Si prefieres, cotiza directo por WhatsApp.
            </p>
          </div>
          <div className="max-w-3xl mx-auto">
            <VisualQuoter defaultCity="Medellín" defaultCategory="Mueble" />
          </div>
        </div>
      </section>
