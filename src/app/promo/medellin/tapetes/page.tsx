          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-6 text-center lg:text-left mb-12 lg:mb-0">
              ...
              <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto lg:mx-0">
                ...
                Reemplazar cuesta 5x más. Nosotros lo dejamos como nuevo desde <strong>$37.500/m²</strong> en Medellín.
              </p>
            ...
            <div className="lg:col-span-6 relative z-10">
              <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] p-6 sm:p-8 border border-gray-100">
                ...
                <div className="space-y-3 mb-4">
                  {[
                    { item: 'Pack 1.20×1.70 m (2 m²)', price: '$90.000', popular: true },
                    { item: 'Pack 1.60×2.30 m (3.7 m²)', price: '$138.000' },
                    { item: 'Pack 2.00×3.00 m (6 m²)', price: '$225.000' },
                    { item: 'Tapete suelto (tarifa)', price: '$37.500/m²' },
                    { item: 'Tapete persa / delicado', price: '$50.000/m²' },
                    { item: 'Alfombra fija instalada', price: '$15.000/m²' },
                  ].map((p) => (
                    <div
                      key={p.item}
                ...
                <p className="text-xs text-gray-400 text-center mb-5">
                  Mínimo 2 m² para tapetes sueltos · Mínimo $350.000 para alfombra fija instalada
                </p>
                <WhatsAppLink
                  message={WA_MESSAGE}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-3">
              Sube una foto y conoce el precio exacto de tu tapete
            </h2>
            <p className="text-gray-500 max-w-xl mx-auto">
              Nuestra IA analiza el tipo y tamaño del tapete y te da un precio estimado al instante.
              Si prefieres, cotiza directo por WhatsApp con las medidas.
            </p>
          </div>
