...
const cases = [
  {
    id: 'sofa',
    title: 'Sofas & Couches',
    description: 'Deep extraction removes embedded stains and restores the original color and texture of your upholstery.',
  ...
  },
  {
    id: 'mattress',
    title: 'Mattresses',
    description: 'Industrial-grade sanitization eliminates dust mites, dead skin cells, and neutralizes deep odors.',
  ...
  },
  {
    id: 'rug',
    title: 'Rugs & Carpets',
    description: 'Fiber restoration and anti-bacterial deep wash — no shrinkage, no damage to delicate weaves.',
  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 text-center">
        <h2 className="text-3xl font-bold text-gray-900 mb-4">Real Results. No Filters.</h2>
        <p className="text-gray-600 mb-10">
          Select a service and drag the slider to see exactly what our deep cleaning process removes.
        </p>
        ...
        <div className="bg-white p-3 sm:p-4 rounded-3xl shadow-xl border border-gray-100">
          ...
          >
            {/* AFTER image — clean version, acts as background */}
            <Image
              src={cases[activeSlide].after}
              alt={`${cases[activeSlide].title} after cleaning`}
              fill
              priority
            ...
            >
              <Image
                ...
                alt={`${cases[activeSlide].title} before cleaning`}
                fill
                priority
                sizes="(max-width: 768px) 100vw, 800px"
                className="object-cover pointer-events-none"
